...
public class AlumnProyect extends JFrame {
	...
	public void inicializarComponentes() {
		...
		// Diseño: Añadir una cajita con el total de estudiantes, otra con los
		// estudiantes asignados a un proyecto y otra los que no tienen ninguno asignado
		// Las líneas de diseño no se encuentran en el código proporcionado.
		...
		addAlumn = new JButton("Editar alumno");
